(function ($) {
	...
	$window.on('load', function () {
		...
		if (plugins.googleMapFooter.length) {
			createMap('footer-map', 14, 49.216627, 28.492076)
		}
	...
	function createMap(id, mapZoom, lat, lng) {
		...
		var mapOptions = {
			...
			center: new google.maps.LatLng(49.216627, 28.492076),
        ...
        var pos1 = new google.maps.LatLng(49.216627, 28.492076);
        // var pos2 = new google.maps.LatLng(49.257117, 28.477987);
